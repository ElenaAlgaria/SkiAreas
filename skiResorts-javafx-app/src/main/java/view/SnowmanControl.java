...
public class SnowmanControl extends Region {
    ...
    private static final StyleablePropertyFactory<SnowmanControl> FACTORY =
    ...
    private static final double ARTBOARD_WIDTH = 110;
    ...
    private static final CssMetaData<SnowmanControl, Color> BASE_COLOR_META_DATA =
        FACTORY.createColorCssMetaData("-base-color", s -> s.baseColor);

    private final StyleableObjectProperty<Color> baseColor = new SimpleStyleableObjectProperty<>(BASE_COLOR_META_DATA) {
        @Override
    ...
    private void setupEventHandlers() {
        this.setOnMouseClicked(event -> setValue(!getValue()));
    }

    private void setupValueChangeListeners() {
        valueProperty().addListener((observable, oldValue, newValue) -> switchHappiness(newValue));
    }
